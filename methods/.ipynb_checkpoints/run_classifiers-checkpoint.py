...
from methods.classifiers.model_params import (
    SMALL_RF_PARAMS, SMALL_XGB_PARAMS, SMALL_MLP_PARAMS,
    LARGE_RF_PARAMS, LARGE_XGB_PARAMS, LARGE_MLP_PARAMS
)
...
def get_params(model_name, n_samples):
    ...
    if model_name == "random_forest":
        return SMALL_RF_PARAMS
    elif model_name == "xgboost":
        return SMALL_XGB_PARAMS
    elif model_name == "mlp":
        return SMALL_MLP_PARAMS
    else:
