...
echo "Example with kmer length = 6 for both start and end kmers; select only the top 2 CoV kmers ; 2 cpus (same as default cpus: 2)"
python main.py -i data/dataset_example/ -s 6 -e 6 -top 2 -cpu 2
